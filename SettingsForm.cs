...
public sealed class SettingsForm : Form
{
    ...
    private readonly CheckBox _startWithWindows = new() { Text = "开机启动", AutoSize = true };
    ...
    private TabPage BuildAdvancedPage()
    {
        ...
        var common=new FlowLayoutPanel{Dock=DockStyle.Fill,FlowDirection=FlowDirection.LeftToRight,WrapContents=false,Margin=Padding.Empty,Padding=new Padding(121,5,0,0)};_topMost.Margin=new Padding(0,4,18,0);_tray.Margin=new Padding(0,4,18,0);_startWithWindows.Margin=new Padding(0,4,0,0);common.Controls.Add(_topMost);common.Controls.Add(_tray);common.Controls.Add(_startWithWindows);table.Controls.Add(common,0,6);table.SetColumnSpan(common,3);
    ...
    private void LoadControls(AppSettings s)
    {
        ...
        _topMost.Checked=s.AlwaysOnTop; _tray.Checked=s.ShowTrayIcon; _startWithWindows.Checked=s.StartWithWindows; _chart.Checked=s.EnableChart; _chartType.Text=s.ChartType; _details.Checked=s.OpenDetailsOnDoubleClick; _doubleClick.Checked=s.OpenDetailsOnDoubleClick; _singleClick.Checked=!s.OpenDetailsOnDoubleClick;
    ...
    private bool ReadControls()
    {
        ...
        Result.EnableBossKey=_boss.Checked; ReadShortcut(_bossShortcut.Text,out var modifiers,out var key); Result.BossKeyModifiers=modifiers; Result.BossKey=key; Result.BossKeyExits=_bossExit.Checked; Result.AlwaysOnTop=_topMost.Checked; Result.ShowTrayIcon=_tray.Checked; Result.StartWithWindows=_startWithWindows.Checked; Result.EnableChart=_chart.Checked; Result.ChartType=_chartType.Text; Result.OpenDetailsOnDoubleClick=_doubleClick.Checked; Result.MonitorDragonTiger=_monitorDragonTiger.Checked; Result.MonitorSevereAbnormal=_monitorSevereAbnormal.Checked; Result.MonitorSealAbnormal=_monitorSealAbnormal.Checked;
